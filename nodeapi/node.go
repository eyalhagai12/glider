...
func (h NodeHandlers) ConnectToVPN(c *gin.Context, request NodeConnectRequest) (map[string]string, error) {
	...
	return map[string]string{"message": "Connected to VPN successfully"}, nil
}
